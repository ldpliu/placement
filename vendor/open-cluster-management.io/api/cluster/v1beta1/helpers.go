...
func GetClustersFromClusterSet(clusterSet *ManagedClusterSet, clusterLister ManagedClusterLister) ([]*v1.ManagedCluster, error) {
	...
	clusters, err = clusterLister.List(clusterSelector)
	if err != nil {
...
func GetClusterSetsOfCluster(cluster *v1.ManagedCluster, clusterSetLister ManagedClusterSetLister) ([]*ManagedClusterSet, error) {
	...
	allClusterSets, err := clusterSetLister.List(labels.Everything())
	if err != nil {
		return nil, err
	}
