...
var map_ManagedClusterSelector = map[string]string{
	"selectorType": "\"\" means to use the current mechanism of matching label <cluster.open-cluster-management.io/clusterset:<ManagedClusterSet Name>. \"LabelSelector\" means to use the LabelSelector to select target managedClusters \"ClusterNames\" means to use \"ClusterNames\" where the managedClusters Name is set",
}
